...
% in the backlimb. Maximum central angle of fault is input. Beyond that,
% the fault propagates at constant fault dip

function chisq = backtrishear(xp,yp,ccx,ccy,ccr,maxarc,ps,tra,slip,ashear,sinc) 
...
% trishear angle tra), slip, shear angle in backlimb (ashear), and slip
% increment (sinc)
