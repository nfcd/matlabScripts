...
%New: Trend and plunge of maximum principal stress direction
[pstress(1,2),pstress(1,3)] = CartToSph(dCp(1,1),dCp(1,2),dCp(1,3));
%Trend and plunge of intermediate principal stress direction
[pstress(2,2),pstress(2,3)] = CartToSph(dCp(2,1),dCp(2,2),dCp(2,3));
%Trend and plunge of minimum principal stress direction
[pstress(3,2),pstress(3,3)] = CartToSph(dCp(3,1),dCp(3,2),dCp(3,3));
