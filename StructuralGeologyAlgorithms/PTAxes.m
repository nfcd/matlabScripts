...
%         Slip vector should be given such that it points in the direction
%         of fault slip: For example, for a thrust fault with strike and 
%         dip (right hand rule) 000/30, and dip slip motion, the trend and
%         plunge of the slip vector should be 270/-30
%
