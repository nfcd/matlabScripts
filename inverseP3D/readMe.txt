...
This optimized 3D trishear inversion uses a gradient based constrained optimization Matlab function (fmincon). The inversion is described in Cardozo and Aanonsen (2009): Journal of Structural Geology 31, 546-560. The inversion is much faster than the standard grid search inversion, but CAREFUL, the results are highly affected by local minima. Always search from different initial estimates to test the consistency of a solution.
