2D inverse trishear fault propagation folding with a circular fault and parallel shear in the backlimb. The maximum central angle of the fault is entered by the user. Beyond that, the fault propagates at a constant dip angle.
