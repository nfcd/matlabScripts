...
Algorithm from Cristallini and Allmendinger (2001): Journal of Structural Geology 23, 1883-1899

Instructions:

1. In Matlab change directory to the forwardP3D folder

2. In the Matlab command window type runmodel

3. Follow the input windows and wait for the program to plot the final 3D geometry of the fold
